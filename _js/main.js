(function($) {
  ...
  tlCompetences.staggerFromTo($('.compemeter'), 2, { widht: '0' }, { width: '100%', ease: Power3.easeInOut }, 0.3);
  ...
  tlSiteOptimises
    ...
    .fromTo(
      ...
      1,
      { rotation: '0deg' },
      { rotation: '90deg', transformOrigin: 'bottom left', ease: Bounce.easeInOut }
    );
  ...
  tlAnim
    ...
    .fromTo($d, 0.2, { x: 0 }, { x: -136, ease: Power4.easeInOut })
    .fromTo($e, 0.2, { x: 0 }, { x: -136, ease: Power4.easeInOut })
    .fromTo($v, 0.2, { x: 0 }, { x: -136, ease: Power4.easeInOut })
    .fromTo($i, 0.2, { x: 0 }, { x: -4, ease: Power4.easeInOut })
    .fromTo($c, 0.2, { x: 0 }, { x: -8, ease: Power4.easeInOut })
    .fromTo($o, 0.2, { x: 0 }, { x: -12, ease: Power4.easeInOut })
    .to($d, 0.5, { x: -156, ease: Power4.easeInOut })
    .to($e, 0.5, { x: -162, ease: Power4.easeInOut })
    .to($v, 0.8, { x: -168, ease: Elastic.easeOut.config(1, 0.3) })
    .to($trois, 0.3, { autoAlpha: 1, ease: Power4.easeInOut })
  ...
  TweenMax.fromTo(
    ...
    4,
    { x: 0 },
    { x: 800, ease: Back.easeOut.config(1.7), y: 0, repeat: -1, repeatDelay: 4, yoyo: false, delay: 4 }
  );
